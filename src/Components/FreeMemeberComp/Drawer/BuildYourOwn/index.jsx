...
export default function BuildYourOwn(props) {
  ...
  return (
    <Box>
      ...
      <Typography variant='h4' gutterBottom className={classes.title} id="responsive-dialog-title" align='center'>Do you want to Build Your Own workout?</Typography>
      <Box m={1} mt={4}>
        <Grid container>
          ...
          <Grid item xs={12} sm={12} md={12} lg={12} className={classes.gridItem}>
            <Link variant="h6" to="/learn-more/build-your-own" component={LinkRef} onClick={handleClose} align='center' > Learn How to use Build Your Own </Link>
          </Grid>
        </Grid>
      </Box>
    </Box>
