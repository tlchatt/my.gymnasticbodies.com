...
const FormSix = (props) => {
  ...
  return (
    <div className={classes.container}>
      <LinearProgress variant="determinate" value={75} classes={{
        root: classes.root, // class name, e.g. `classes-nesting-root-x`
      }}/>
        <Grid item xs={12} sm={12} md={12} lg={12} className={[classes.margin8, classes.paddingLeft].join(' ')}>
          <h2 className={classes.gfTitle}>Mobility 2 of 2</h2>
          <h3 className={classes.gfSubText}>Front Line mobility means that your quads, abs, shoulders and upper back are all flexible.</h3>
        </Grid>
